...
public partial class Save
{
    ...
    public class SaveData
    {
        ...
        [Key(1)] public Dictionary<(int,int), int[]> Chunks { get; set; } = new Dictionary<(int,int),int[]>();
    }
    ...
    public SaveData LoadSave()
    {
        ...
        try
        {
            ...
            if (DebugManager.Instance != null)
                DebugManager.Log("Data loaded successfully.");
            return Data;
        }
        catch (Exception e)
        {
    ...
    public void SavePlayerInformation(Vector3 position)
    {
