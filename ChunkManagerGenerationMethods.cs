...
public partial class ChunkManager : Node
{
    ...
    public static readonly Noise CELLNOISE = new FastNoiseLite()
    {
    ...
    public static void Generate(Vector3I chunkPosition)
    {
        ...
        //Instance.DeferredMeshUpdates[chunkPosition] = new();
    }
    ...
    /*
    // HACK these methods proved to be unnecessary but code may prove useful elsewhere
    private void PopulateChunkNeighbourBlocks(Vector3I chunk_index)
    {
    ...
    private void UpdateChunkBlockSlopes(Vector3I chunk_index)
    {
