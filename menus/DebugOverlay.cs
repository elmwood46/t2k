...
public partial class DebugOverlay : Control
{
    ...
    public override void _Process(double delta) {
        ...
        PlayerInfo.Text += $"{Mathf.FloorToInt(Player.Instance.Position.X/ChunkManager.Dimensions.X)},";
        PlayerInfo.Text += $"{Mathf.FloorToInt(Player.Instance.Position.Z/ChunkManager.Dimensions.Z)}\n";
